...
public class DishValue {
    ...
    public DishValue(double x, double y, int value, ImagesLoader imsLoader, Camera camera) {
        ...
        blueNumbers = imsLoader.getFrames("numerosAzul");
        redNumbers = imsLoader.getFrames("numerosRojo");
        powerup = imsLoader.getImage("powerup");
