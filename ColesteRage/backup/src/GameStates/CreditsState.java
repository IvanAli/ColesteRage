...
public class CreditsState extends GameState {
	...
	public void update() {
		...
		x += dx;
		y += dy;
		if(y + 1030 < 0) gsm.setState(GameStateManager.NAMEENTRY);
	}
	...
	public void draw(Graphics2D g) {
		...
		Text.drawString(g, "Mother 3 - Nintendo", Text.CENTERED, (int)(y + 690), "leishoFont", null);
		Text.drawString(g, "Música", Text.CENTERED, (int)(y + 750), "leishoFont", null);
		Text.drawString(g, "Mario Paint - Nintendo", Text.CENTERED, (int)(y + 790), "leishoFont", null);
		Text.drawString(g, Character.toString((char)169) + "2015 Equipo", Text.CENTERED, (int)(y + 1000), "leishoFont", null);
	}
