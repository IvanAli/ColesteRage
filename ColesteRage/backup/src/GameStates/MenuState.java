...
public class MenuState extends GameState {
    ...
    public void init() {
        ...
        // images loader init
        imsLoader = new ImagesLoader("menu_imagenes.txt");
        
        // start the audio
        audio = new AudioPlayer(new AudioLoader("menu_sonido.txt"));
    	...
    	bgMenu = new Background(
				0, 
				0, 
				imsLoader.getImage("bgMenu"), 
				Background.MOVEUP
		);
    	bgMenu.setVector(0, 3);
    	
        // play the audio
    	if(!audio.isPlaying("menumusic")) {
    		System.out.println("Not playing menu music");
    		audio.playAndLoop("menumusic");
    	}

        // animation init
        bodoque = new MovingAnimation(imsLoader.getImage("bodoque_left"), GamePanel.WIDTH + 190, 400, MovingAnimation.TOLEFT, 150);
        logotype = new MovingAnimation(imsLoader.getImage("colesterage_logo"), GamePanel.WIDTH / 2, -120, MovingAnimation.TODOWN, 50);
    ...
    public void draw(Graphics2D g) {
        ...
        g.drawImage(imsLoader.getImage("menu_bg"), 0, 0, null);
        bgMenu.draw(g);
        if(ticks > 50) {
            ...
            g.drawImage(imsLoader.getImage("menuhighlight"), 0, menuBorderY, null);
            ...
            */
            //g.drawImage(imsLoader.getImage("menu_optionborder"), 500, menuBorderY, null);
        }
        //g.drawImage(imsLoader.getImage("bodoque_left"), 20, 60, null);
        bodoque.draw(g);
        logotype.draw(g);
        
        //logo.drawImage(g, 400, 120, -1f);
        //g.drawImage(imsLoader.getImage("colesterage_logo"), 400, 60, null);
