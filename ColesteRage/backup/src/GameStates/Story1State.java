...
public class Story1State extends GameState {
	...
	public void init() {
		...
		imsLoader = new ImagesLoader("nivel1_historia.txt");
		audio = new AudioPlayer(new AudioLoader("historia1_sonido.txt"));
		
		audio.playAndLoop("story1music");
	...
	public void draw(Graphics2D g) {
		...
		// draw the enter key
			if(enterTicks < 15)
				g.drawImage(imsLoader.getImage("enterkey"), 1120, 395, null);
