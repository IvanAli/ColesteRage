...
public class Story4State extends GameState {
	...
	public void init() {
		...
		imsLoader = new ImagesLoader("nivel4_historia.txt");
		
		dialogs = new String[NUM_DIALOGS];
		
		dialogs[0] = "Después de su paso por el supermercado, Bodoque se aburrió de los mismos empaques "
				+ "coloridos y azucarados.";
		dialogs[1] = "Debido a esto, Bodoque optó por ir a un restaurante, donde preparan todo tipo de comida "
				+ "grasosa y en distintas presentaciones.";
	...
	public void update() {
		...
		if(ticks == FADEIN + FADEOUT) gsm.setState(GameStateManager.LEVEL4);
