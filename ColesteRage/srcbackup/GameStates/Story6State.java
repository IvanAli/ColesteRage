...
public class Story6State extends GameState {
	...
	public void init() {
		...
		dialogs[0] = "Esta fue la última parada de Bodoque.";
		dialogs[1] = "Después de ganar el concurso, su mamá logró alcanzarlo pero fue muy tarde...";
		dialogs[2] = "Bodoque tenía todas sus arterias llenas de colesterol y estaba al borde del infarto.";
		dialogs[3] = "La señora pidió una ambulancia, y se llevaron al pobre Bodoque al hospital.";
		dialogs[4] = "Inmediatamente le realizaron una cirugía a corazón abierto.";
