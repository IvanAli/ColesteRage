...
public class Level4State extends GameState {
    ...
    private final String musicFnm = "nivel4_bg";
    
    // next state
    private final int nextState = GameStateManager.STORY5;
    
    // level name
    private final String levelName = "NIVEL 4";
    ...
    public void init() {
    	...
    	// AudioPlayer init
    	AudioLoader.loadFromFile("nivel4_sonido.txt");
        
        // images loading
        ImagesLoader.loadFromFile("nivel4_imagenes.txt");
        ...
        bgKitchen = new Background(0, 0, ImagesLoader.getImage("4_background"), Background.MOVELEFT);
    ...
    public void input() {
        ...
        if(eventCaught) {
            if(Keys.isPressed(Keys.ENTER)) {
            	...
            	ImagesLoader.removeImages("nivel4_imagenes.txt");
            	...
            	AudioLoader.removeAudio("nivel4_sonido.txt");
            }
        }
        if(eventDead) {
        	if(Keys.isPressed(Keys.ENTER)) {
