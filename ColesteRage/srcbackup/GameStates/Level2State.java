...
public class Level2State extends GameState {
    ...
    private final String musicFnm = "nivel2_bg";
    
    // next state
    private final int nextState = GameStateManager.STORY3;
    
    // level name
    private final String levelName = "NIVEL 2";
    ...
    public void init() {
    	...
    	// AudioPlayer init
    	AudioLoader.loadFromFile("nivel2_sonido.txt");
        
        // images loading
        ImagesLoader.loadFromFile("nivel2_imagenes.txt");
        ...
        bgKitchen = new Background(0, 0, ImagesLoader.getImage("2_background"), Background.MOVELEFT);
    ...
    public void input() {
        ...
        if(eventCaught) {
            if(Keys.isPressed(Keys.ENTER)) {
            	...
            	ImagesLoader.removeImages("nivel2_imagenes.txt");
            	...
            	AudioLoader.removeAudio("nivel2_sonido.txt");
            }
        }
        if(eventDead) {
        	if(Keys.isPressed(Keys.ENTER)) {
