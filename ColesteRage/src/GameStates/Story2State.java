...
public class Story2State extends GameState {
	...
	private final String musicFnm = "story2music";
	...
	public void init() {
		...
		ImagesLoader.loadFromFile("historia2_imagenes.txt");
		AudioLoader.loadFromFile("historia2_sonido.txt");
	...
	public void update() {
		...
		if(ticks == FADEIN + FADEOUT) {
			...
			ImagesLoader.removeImages("historia2_imagenes.txt");
			AudioLoader.removeAudio("historia2_sonido.txt");
