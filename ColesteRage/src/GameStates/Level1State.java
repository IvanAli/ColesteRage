...
public class Level1State extends GameState {
    ...
    // next state
    private final int nextState = GameStateManager.STORY2;
    
    // level name
    private final String levelName = "NIVEL 1";
    ...
    public void init() {
    	...
    	// AudioPlayer init
    	AudioLoader.loadFromFile("nivel1_sonido.txt");
        
        // images loading
        ImagesLoader.loadFromFile("nivel1_imagenes.txt");
    ...
    public void input() {
        ...
        if(eventCaught) {
            if(Keys.isPressed(Keys.ENTER)) {
            	...
            	ImagesLoader.removeImages("nivel1_imagenes.txt");
            	...
            	AudioLoader.removeAudio("nivel1_sonido.txt");
            }
        }
        if(eventDead) {
        	if(Keys.isPressed(Keys.ENTER)) {
