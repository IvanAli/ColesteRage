...
public class Level3State extends GameState {
    ...
    private final String musicFnm = "nivel3_bg";
    
    // next state
    private final int nextState = GameStateManager.STORY4;
    
    // level name
    private final String levelName = "NIVEL 3";
    ...
    public void init() {
        ...
        bg = new Background(0, 0, ImagesLoader.getImage("3_background"), Background.MOVELEFT);
