...
public class MenuState extends GameState {
    ...
    public void init() {
        ...
        // animation init
        bodoque = new MovingAnimation(ImagesLoader.getImage("bodoque_left"), GamePanel.WIDTH + 250, 400, MovingAnimation.TOLEFT, 150);
    ...
    public void update() {
        ...
        if(enter) {
            ...
            if(currentOption == TOPSCORES) {
            	ImagesLoader.removeImages("menu_imagenes.txt");
            	AudioLoader.removeAudio("menu_sonido.txt");
            	gsm.setState(GameStateManager.TOPSCORES);
            }
            if(currentOption == OPTIONS) {
            	//audio.stop("menumusic");
            	ImagesLoader.removeImages("menu_imagenes.txt");
