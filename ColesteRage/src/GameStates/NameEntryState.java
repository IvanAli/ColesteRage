...
public class NameEntryState extends GameState {
	...
	private final String fnm = "colesteragebest.cr";
	...
	public void init() {
		...
		topPlayers = IOPlayers.getTopPlayers();
		topFive = isTopFive();
	...
	*/
	...
	public void input() {
		if(saved || !topFive) {
			...
			System.out.println("Current x: " + currentOptionx + ". Current y: " + currentOptiony);
			if(Keys.isPressed(Keys.LEFT)) {
				AudioPlayer.play("menu_mover2");
				currentOptionx--;
				if(currentOptiony == 4) {
					if(currentOptionx < 11) currentOptionx = 12;
				}
				else
			...
			if(Keys.isPressed(Keys.RIGHT)) {
				...
				currentOptionx++;
				if(currentOptionx > 12) {
					if(currentOptiony == 4) currentOptionx = 11;
					else currentOptionx = 0;
				}
			}
