...
public class HUD {
    ...
    public void draw(Graphics2D g) {
    	...
    	if(cholesterol >= 0) g.setColor(new Color(255, 19, 19));
    	if(cholesterol >= 50) g.setColor(new Color(122, 19, 141));
    	if(cholesterol >= 75) g.setColor(new Color(19, 19, 141));
    	//g.setColor(new Color(140, 0, 170));
        ...
        g.drawImage(
        		...
        		870 - ImagesLoader.getImage("timebox").getWidth() / 2, 
        		15, 
        		null
		);
        ...
        */
        ...
        Text.drawString(g, getScore(score), 800, 40, "yummyFont", null);
